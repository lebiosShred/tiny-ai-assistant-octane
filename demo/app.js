...
<body>
    ...
    const BATTLECARDS = {
        A: [
            {q: "What general ledger/ERP system (e.g., SAP, MS Business Central, NetSuite) are you using, and does it currently integrate with your planning tool?", tip: "Understand current general ledger/ERP stack."},
            {q: "How many separate Excel spreadsheets are you manually consolidating for your budgeting and forecasting, and are there issues with version control?", tip: "Find manual compilation and consolidation bottlenecks."},
            {q: "What specific planning workflows (e.g., actuals, payroll allocations, cost analysis, budgeting, forecasting) are you executing, and are allocations inconsistent or time-consuming?", tip: "Map active budgeting/forecasting loops."},
            {q: "What reporting tools (e.g., Power BI, Qlik, Tableau, Excel PAX/PAW) do you use for management reporting, and do you manually export CSV files to reconcile data?", tip: "Identify management reporting tools."},
            {q: "Do users need to drill down from high-level reports to transaction-level GL data, and do you perform multi-currency transactions?", tip: "Check currency translation and granular transactional drill-down."},
            {q: "Do you have internal developers/admins to manage these systems, or is there a key-person risk if someone leaves?", tip: "Evaluate internal admin capabilities and key-person risk."},
            {q: "How many planning contributors, read-only users, and administrators are involved, and would they need formal training?", tip: "Qualify license counts and training demands."},
            {q: "What repetitive financial tasks feel most manual, and would conversational AI access to financial queries benefit your executives?", tip: "Highlight repetitive operations ripe for AI coprocessor."},
            {q: "What is your target timeline for going live, and do you need a parallel run (e.g., completing by a specific month like June)?", tip: "Confirm go-live schedule and parallel run constraints."},
            {q: "Is there a budget allocated for licensing and delivery, and what is your internal approval/purchase order process?", tip: "Qualify approval workflow and budget bounds."},
            {q: "Have you evaluated other tools (e.g. Anaplan, Jedox, Workday), and who else is involved in the final decision?", tip: "Discover competing tool reviews and decision-makers."},
            {q: "What does success look like, and would a 60-day trial of connectors (like DataFusion) or a free Proof of Concept (POC) help validate the solution?", tip: "Position Proof of Concept (POC) validation strategy."}
        ],
        B: [
            {q: "What version of TM1/Planning Analytics are you running, and is it deployed on-premise or in the IBM Cloud?", tip: "Determine database version and host environment."},
            {q: "How many TM1 instances do you run (e.g., production-only, or separate dev and test environments)?", tip: "Identify server instance landscape (Dev, Test, Prod)."},
            {q: "How many models, cubes, dimensions, and user groups are you currently running?", tip: "Audit TM1 architecture scale."},
            {q: "Have you checked your system's performance, RAM usage, hard disk space, or feeder memory usage? Are they approaching high limits?", tip: "Locate resource bottlenecks or slow calculation times."},
            {q: "Are log files being automatically cleared, and what is the typical size of your TM1 log files (e.g., is it under or over the 50MB standard)?", tip: "Track log rotation and housekeeping rules."},
            {q: "What are the typical report load times for your end-users, and are they above the 5-second threshold?", tip: "Isolate report delivery delays."},
            {q: "Do you have dedicated in-house TM1 administrators/developers, or are you dependent on key individuals?", tip: "Assess staffing overhead and admin team capability."},
            {q: "Are you currently working with another TM1 vendor? Are you locked into a rigid contract with separate rates for support and development?", tip: "Uncover competitor agreements and pricing models."},
            {q: "What is your current backlog of enhancements, bugs, or data reconciliation tasks, and how is it prioritized?", tip: "Uncover unresolved bugs or backlog blockages."},
            {q: "Have your TM1 developers and power users had formal training, and would they benefit from free access to professional training courses?", tip: "Offer support team training packages."},
            {q: "Are you using Power BI, Tableau, or Qlik, and do you have a direct database connection or are you manually handling CSVs?", tip: "Check downstream BI reporting pipelines."},
            {q: "Who has final authority to approve support changes, and what is the timeline to transition support (e.g. target date like October 31)?", tip: "Qualify approval hierarchy and target transition date."}
        ],
        C: [
