...
8. If the user asks to save, register, or log call notes, summaries, transcripts, or details, but does not explicitly provide the conversation notes, content, or transcript text within their prompt, you MUST exercise skepticism. Do NOT assume or fabricate details from pre-existing profile or intake answers. Instead, suspend calling 'register_call_log' and politely ask the user to provide the specific details of their conversation.`;
